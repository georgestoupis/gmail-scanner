...
class ScanResultMapperTest {
  ...
  void fromOrderMap_dividesByTwelveForPastYear() {
    ...
    ScanResult result = mapper.fromOrderMap(Group.FOOD, 2023, Map.of(Source.EFOOD, List.of(order)));
  ...
  void fromOrderMap_dividesByCurrentMonthForCurrentYear() {
    ...
    ScanResult result = mapper.fromOrderMap(Group.FOOD, currentYear, Map.of(Source.EFOOD, List.of(order)));
  ...
  void fromOrderMap_aggregatesTotalAcrossSources() {
    ...
    ScanResult result = mapper.fromOrderMap(Group.FOOD, 2023, Map.of(
  ...
  void fromOrderMap_handlesEmptyOrderListForSource() {
    ScanResult result = mapper.fromOrderMap(Group.FOOD, 2023, Map.of(Source.EFOOD, List.of()));
  ...
  void fromOrderMap_countsOrdersAndSumsPerSource() {
    ...
    ScanResult result = mapper.fromOrderMap(Group.FOOD, 2023, Map.of(Source.EFOOD, List.of(o1, o2)));
  ...
  void fromOrderMap_setsGroupAndPeriod() {
    ScanResult result = mapper.fromOrderMap(Group.GAMES, 2024, Map.of(Source.STEAM, List.of()));
    assertThat(result.group()).isEqualTo(Group.GAMES);
