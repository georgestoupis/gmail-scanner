...
public final class FoodQueries {
  ...
  public static final Map<Source, String> SOURCE_QUERIES_MAP = Map.of(
      Source.EFOOD, "from:noreply@e-food.gr AND {subject:Η παραγγελία σου subject:από το efood!}",
      Source.WOLT, "from:info@wolt.com AND {subject:Your order’s confirmed subject:Your order's delivered subject:Η παραγγελία σου παραδόθηκε}",
